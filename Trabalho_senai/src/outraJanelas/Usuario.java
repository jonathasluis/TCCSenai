...
public class Usuario {
	...
	private void initialize() {
		...
		frmUsuario.setIconImage(Toolkit.getDefaultToolkit().getImage(CadastrarFuncionarios.class.getResource("/img/32x32.png")));
		...
		ImageIcon icon = new ImageIcon("src/img/usu1.png");
